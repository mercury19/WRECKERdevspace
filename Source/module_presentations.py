  ...
  ("game_custom_battle_designer", prsntf_manual_end_only, mesh.cb_ui_main, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_1),
        (assign, ":cur_troop", "trp_swadian_knight"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_2),
        (assign, ":cur_troop", "trp_vaegir_knight"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_3),
        (assign, ":cur_troop", "trp_khergit_veteran_horse_archer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_4),
        (assign, ":cur_troop", "trp_nord_champion"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_5),
        (assign, ":cur_troop", "trp_rhodok_sergeant"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", fac.kingdom_6),
...
##      (overlay_set_size, "$g_presentation_obj_custom_battle_designer_4", pos1),
      ...
      (else_try),
        (try_for_range, ":cur_faction", npc_kingdoms_begin, npc_kingdoms_end),
          ...
          (overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", s0),
        (try_end),
        (str_store_faction_name, s0, fac.outlaws),
        (overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", s0),
      (try_end),
      (try_begin),
        (eq, "$g_quick_battle_team_1_faction", fac.outlaws),
...
##      (overlay_set_size, "$g_presentation_obj_custom_battle_designer_5", pos1),
      ...
      (try_end),
      (try_begin),
        (eq, "$g_quick_battle_team_2_faction", fac.outlaws),
        (store_sub, ":overlay_value", npc_kingdoms_end, npc_kingdoms_begin),
      ...
      (call_script, script.get_army_size_from_slider_value, "$g_quick_battle_army_1_size"),
      ...
      (call_script, script.get_army_size_from_slider_value, "$g_quick_battle_army_2_size"),
     ...
     [
       ...
       (else_try),
         ...
         (else_try),
           ...
           (try_begin),
             (eq, "$g_quick_battle_team_1_faction", 0),
             (assign, "$g_quick_battle_team_1_faction", fac.outlaws),
           (else_try),
             (val_add, "$g_quick_battle_team_1_faction", npc_kingdoms_begin),
           ...
           (try_for_range, ":unused", 0, ":end_cond"),
             ...
             (try_begin),
               ...
               (assign, "$g_quick_battle_team_2_faction", fac.outlaws),
             (else_try),
               (val_add, "$g_quick_battle_team_2_faction", npc_kingdoms_begin),
       ...
       (else_try),
         ...
         (try_begin),
           ...
           (call_script, script.spawn_quick_battle_army, 0, "$g_quick_battle_team_1_faction", "$g_presentation_obj_custom_battle_designer_6_last_value", "$g_presentation_obj_custom_battle_designer_7_last_value", "$g_presentation_obj_custom_battle_designer_8_last_value", 0, 1),
           (call_script, script.spawn_quick_battle_army, 16, "$g_quick_battle_team_2_faction", "$g_presentation_obj_custom_battle_designer_9_last_value", "$g_presentation_obj_custom_battle_designer_10_last_value", "$g_presentation_obj_custom_battle_designer_11_last_value", 0, 0),
         (else_try),
           (eq, "$g_quick_battle_game_type", 1), #siege offense
           (assign, ":cur_mission_template", "mt_quick_battle_siege"),
           (modify_visitors_at_site, ":cur_scene"),
           (call_script, script.spawn_quick_battle_army, 16, "$g_quick_battle_team_1_faction", "$g_presentation_obj_custom_battle_designer_6_last_value", "$g_presentation_obj_custom_battle_designer_7_last_value", "$g_presentation_obj_custom_battle_designer_8_last_value", 0, 1),
           (call_script, script.spawn_quick_battle_army, 0, "$g_quick_battle_team_2_faction", "$g_presentation_obj_custom_battle_designer_9_last_value", "$g_presentation_obj_custom_battle_designer_10_last_value", "$g_presentation_obj_custom_battle_designer_11_last_value", 1, 0),
         (else_try),
           #siege defense
           (assign, ":cur_mission_template", "mt_quick_battle_siege"),
           (modify_visitors_at_site, ":cur_scene"),
           (call_script, script.spawn_quick_battle_army, 0, "$g_quick_battle_team_1_faction", "$g_presentation_obj_custom_battle_designer_6_last_value", "$g_presentation_obj_custom_battle_designer_7_last_value", "$g_presentation_obj_custom_battle_designer_8_last_value", 1, 1),
           (call_script, script.spawn_quick_battle_army, 16, "$g_quick_battle_team_2_faction", "$g_presentation_obj_custom_battle_designer_9_last_value", "$g_presentation_obj_custom_battle_designer_10_last_value", "$g_presentation_obj_custom_battle_designer_11_last_value", 0, 0),
         (try_end),
...
#INVASION MODE END
      ...
      (call_script, script.multiplayer_fill_map_game_types, "$g_multiplayer_game_type"),
...
#INVASION MODE END
      ...
      (call_script, script.multiplayer_fill_available_factions_combo_button, "$g_presentation_obj_admin_panel_11", "$g_multiplayer_next_team_1_faction", "$g_multiplayer_next_team_2_faction"),
	  ...
	  (try_begin),
		...
		(call_script, script.multiplayer_fill_available_factions_combo_button, "$g_presentation_obj_admin_panel_12", "$g_multiplayer_next_team_2_faction", "$g_multiplayer_next_team_1_faction"),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        #INVASION MODE START
		(call_script, script.multiplayer_set_g_multiplayer_is_game_type_captain),
		#(tutorial_message, -1), 
		(try_begin),
			(eq, "$g_multiplayer_is_game_type_captain", 1),
		...
		(else_try), 
          ...
          (assign, "$g_multiplayer_next_team_2_faction", fac.kingdom_2),
...
##        (try_end),
      ...
      (else_try),
        ...
        (try_begin),
          (eq, ":value", 6),
          (assign, "$g_multiplayer_next_team_2_faction", fac.outlaws),
        (else_try),
          (eq, ":value", 7),
          (assign, "$g_multiplayer_next_team_2_faction", fac.ccoop_all_stars),
        (else_try),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (str_store_string, s2, "str_s2_s3"),
        (assign, ":end_cond", 1000),
        (call_script, script.game_multiplayer_get_game_type_mission_template, "$g_multiplayer_game_type"),
        (assign, ":cur_mt", reg0),
        ...
        (try_for_range, ":cur_option", 0, ":end_cond"),
          ...
          (call_script, script.game_get_multiplayer_server_option_for_mission_template, ":cur_mt", ":cur_option"),
          (try_begin),
            (eq, reg0, -12345),
            (assign, ":end_cond", 0),
          (else_try),
            (call_script, script.game_multiplayer_server_option_for_mission_template_to_string, ":cur_mt", ":cur_option", reg0),
    ...
    (ti_on_presentation_run,
     [
       ...
       (try_begin),
         ...
         (presentation_set_duration, 0),
         (neg|is_presentation_active, prsnt.multiplayer_escape_menu),
         (neg|is_presentation_active, prsnt.multiplayer_team_select),
  ...
  ("multiplayer_team_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        (call_script, script.cf_multiplayer_team_is_available, ":my_player_no", 0),
	  ...
	  (try_begin), ##ccoop
        ...
        (try_end),
        (try_begin),
          (call_script, script.cf_multiplayer_team_is_available, ":my_player_no", 1),
          (try_begin),
	        (neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              #INVASION MODE START
			  (call_script, script.mp_set_player_team_no, ":my_player_no", 0, 1),
			  (try_begin),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              #INVASION MODE START
			  (call_script, script.mp_set_player_team_no, ":my_player_no", 1, 1),
			  (try_begin),
				(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
				(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_deathmatch),
				(eq, "$g_multiplayer_game_type", multiplayer_game_type_duel),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":i_button", multi_data_troop_button_indices_begin, ":end_cond"),
        ...
        (try_begin),
          ...
          (call_script, script.multiplayer_set_default_item_selections_for_troop, ":selected_troop_no"),
          (call_script, script.multiplayer_send_item_selections),
        (try_end),
        (presentation_set_duration, 0),
		...
		(try_begin),
		  ...
		  (call_script, script.cf_multiplayer_can_buy_squad),
     ...
     [
      (try_begin),
        ...
        #INVASION MODE START
		  ...
		  (call_script, script.mp_set_player_team_no, ":my_player_no", multi_team_spectator, 1),
        (else_try),
        #INVASION MODE END
          (neg|is_between, ":my_troop", multiplayer_troops_begin, multiplayer_troops_end),
          (player_set_troop_id, ":my_player_no", -1),
  ...
  ("multiplayer_item_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (call_script, script.multiplayer_calculate_cur_selected_items_cost, ":my_player_no", 1),
      ...
      (try_begin),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_weapons_begin, multi_item_class_type_weapons_end, 781, 474),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_weapons_begin, multi_item_class_type_weapons_end, 781, 374),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_weapons_begin, multi_item_class_type_weapons_end, 781, 274),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_weapons_begin, multi_item_class_type_weapons_end, 781, 174),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_heads_begin, multi_item_class_type_heads_end, 117, 524),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_bodies_begin, multi_item_class_type_bodies_end, 117, 424),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_left_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_feet_begin, multi_item_class_type_feet_end, 117, 324),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_left_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_gloves_begin, multi_item_class_type_gloves_end, 117, 224),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_left_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (eq, "$g_horses_are_avaliable", 1),
        (call_script, script.multiplayer_display_available_items_for_troop_and_item_classes, ":my_troop_no", multi_item_class_type_horses_begin, multi_item_class_type_horses_end, 117, 124),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_left_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, script.mp_set_coop_companions, ":my_player_no"),
        #(call_script, script.multiplayer_create_available_troops_buttons, ":my_player_no", ":my_faction_no"),
        ...
        (try_begin),
          ...
          #(call_script, script.multiplayer_fill_companion_select_combo_button, "$g_presentation_obj_coop_companion_select_0", "$g_presentation_obj_coop_companion_0"),
          (position_set_x, pos1, 700),
          (position_set_y, pos1, 700),
          ...
          #(call_script, script.multiplayer_fill_companion_select_combo_button, "$g_presentation_obj_coop_companion_select_1", "$g_presentation_obj_coop_companion_1"),
          (position_set_x, pos1, 700),
          (position_set_y, pos1, 700),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (try_begin),
                (call_script, script.cf_multiplayer_is_item_default_for_troop, ":item_no", ":my_player_troop_no"),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (try_for_range, ":cur_slot", multi_data_item_button_indices_begin, ":end_cond"),
			...
			(try_begin),
              ...
              (call_script, script.multiplayer_update_cost_labels),
              (assign, ":end_cond", 0), #break
            (try_end),
          (try_end),
          (presentation_set_duration, 0),
        ...
        (try_begin),
          ...
          (call_script, script.multiplayer_set_default_item_selections_for_troop, ":my_troop_no"),
          (presentation_set_duration, 0),
          (assign, "$g_presentation_state", 0),
          (start_presentation, prsnt.multiplayer_item_select),
        (else_try),
...
##      (try_end),
  ...
  ("multiplayer_team_score_display", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [
      ...
      (try_begin),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_4),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_1"),
      (else_try),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_2),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_2"),
      (else_try),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_3),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_3"),
      (else_try),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_5),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_4"),
      (else_try),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_6),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_5"),
      (else_try),
        (eq, "$g_multiplayer_team_1_faction", fac.kingdom_1),
      ...
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_4),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_1"),
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_2),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_2"),
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_3),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_3"),
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_5),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_4"),
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_6),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_5"),
      (else_try),
        (eq, "$g_multiplayer_team_2_faction", fac.kingdom_1),
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_6"),
      (try_end),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin), #counting number of flags each team has.
        (eq, "$g_multiplayer_game_type", multiplayer_game_type_headquarters),
        (call_script, script.get_headquarters_scores),
      ...
      (try_for_range, ":i_team", 0, multi_team_spectator),
        ...
        (try_begin),
          ...
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_7"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_4),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_1"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_2),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_2"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_3),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_3"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_5),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_4"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_6),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_5"),
        (else_try),
          (eq, ":cur_faction", fac.kingdom_1),
          (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_6"),
        (try_end),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (try_begin),
		...
		(call_script, script.multiplayer_ccoop_get_alive_enemy_count),
      ...
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (try_begin),
          ...
          (str_store_faction_name, s7, fac.player_supporters_faction),
      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          ...
          (faction_set_name, fac.player_supporters_faction, s7),
          (faction_set_color, fac.player_supporters_faction, 0xFF0000),
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_begin),
          ...
          (assign, "$g_presentation_next_presentation", prsnt.custom_banner),
        ...
        (else_try),
          ...
          (call_script, script.get_random_custom_banner, "trp_player"),
          (start_presentation, prsnt.custom_banner),
        (else_try),
   ...
   [
     (ti_on_presentation_load,
      [
        ...
        (assign, ":pos_x", 125),
        (assign, ":pos_y", 400),
        (call_script, script.get_troop_custom_banner_num_positionings, "trp_player"),
     ...
     (ti_on_presentation_load,
      [
        ...
        (try_for_range, ":i_color", 0, 42),
          (call_script, script.get_custom_banner_color_from_index, ":i_color"),
     ...
     (ti_on_presentation_load,
      [
        ...
        (try_begin),
          ...
          (assign, "$g_presentation_next_presentation", prsnt.marshall_selection),
        (else_try),
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_begin),
          ...
          (val_add, "$g_presentation_marshall_selection_1_vote", 1),
          (call_script, script.change_player_relation_with_troop, "$g_presentation_marshall_selection_max_renown_1_troop", 2),
          (call_script, script.change_player_relation_with_troop, "$g_presentation_marshall_selection_max_renown_2_troop", -2),
        (else_try),
          ...
          (else_try),
           ...
           (try_end),  
            ...
            (try_begin),
              ...
              (call_script, script.change_player_relation_with_troop, "$g_presentation_marshall_selection_max_renown_2_troop", -3),
            (try_end),
  ...
  ("battle",0,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (call_script, script.update_order_panel, ":player_team"),
        ...
        (call_script, script.update_order_panel_checked_classes),
        (call_script, script.update_order_panel_statistics_and_map),
      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          ...
          (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_spread_out),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_15"),
          (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_stand_closer),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_16"),
          (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_fall_back),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_17"),
          (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_advance),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_10"),
          (try_begin),
            (eq, ":value", 3),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_hold),
            (call_script, script.update_order_panel, ":player_team"),
            (assign, "$g_latest_order_1", 3),
          (else_try),
            (eq, ":value", 2),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_follow),
            (call_script, script.update_order_panel, ":player_team"),
            (assign, "$g_latest_order_1", 2),
          (else_try),
            (eq, ":value", 1),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_charge),
            (call_script, script.update_order_panel, ":player_team"),
##          (else_try),
##            (eq, ":value", 4),
##            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_advance),
...
##            (call_script, script.update_order_panel, ":player_team"),
          ...
          (else_try),
            (eq, ":value", 0),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_stand_ground),
            (call_script, script.update_order_panel, ":player_team"),
        ...
        (else_try),
          ...
          (try_begin),
            (eq, ":value", 1),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_mount),
            (call_script, script.update_order_panel, ":player_team"),
            (assign, "$g_latest_order_2", 1),
          (else_try),
            (eq, ":value", 0),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_dismount),
            (call_script, script.update_order_panel, ":player_team"),
        ...
        (else_try),
          ...
          (try_begin),
            (eq, ":value", 1),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_hold_fire),
            (call_script, script.update_order_panel, ":player_team"),
            (assign, "$g_latest_order_3", 1),
          (else_try),
            (eq, ":value", 0),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_fire_at_will),
            (call_script, script.update_order_panel, ":player_team"),
        ...
        (else_try),
          ...
          (try_begin),
            (eq, ":value", 1),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_use_any_weapon),
            (call_script, script.update_order_panel, ":player_team"),
            (assign, "$g_latest_order_4", 1),
          (else_try),
            (eq, ":value", 0),
            (call_script, script.team_give_order_from_order_panel, ":player_agent", mordr_use_blunt_weapons),
            (call_script, script.update_order_panel, ":player_team"),
        ...
        (else_try),
          ...
          (try_end),        
          (call_script, script.update_order_flags_on_map),
          (call_script, script.update_order_panel, ":player_team"),
        (try_end),
   ...
   [(ti_on_presentation_load,
     [(presentation_set_duration, 999999),
      ...
      (try_begin),
        ...
        (neq, "$players_kingdom", fac.player_faction),
      ...
      (try_for_parties, ":party_no"),
        ...
        (else_try),
		  ...
		  (eq, ":center_faction", fac.player_supporters_faction),
      ...
      (try_for_range, ":center_no", centers_begin, centers_end),		
        ...
        (try_begin),
		  ...
		  (call_script, script.process_player_enterprise, ":enterprise_output", ":center_no"),
		  ...
		  (call_script, script.get_enterprise_name, ":enterprise_output"),
      ...
      (try_begin),
        ...
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg1, pos1),
        (call_script, script.party_calculate_strength, "p_main_party", 0),
        (assign, ":offer_value", reg0),
        (val_div, ":offer_value", 2),
        (val_add, ":offer_value", 30),
        (call_script, script.round_value, ":offer_value"),
      ...
      (try_for_parties, ":party_no"),
        ...
        (try_for_range, ":i_stack", 0, ":num_stacks"),
          ...
          (call_script, script.game_get_troop_wage, ":stack_troop", ":party_no"),
...
##        (gt, ":total_wage", 0),
      ...
      (try_begin),
        ...
        (call_script, script.objectionable_action, tmt_egalitarian, "str_men_unpaid"),
      (try_end),
	...
	("multiplayer_flag_projection_display_ccoop", prsntf_read_only|prsntf_manual_end_only, 0, [
      ...
      [
	    (try_begin),
		  ...
		  (call_script, script.avarage_of_two_points),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_run, [
      (is_presentation_active, prsnt.multiplayer_ccoop_next_wave_time_counter),      
      (presentation_set_duration, 0), 
      ]),
    ]),
    #INVASION MODE END
